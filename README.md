...
**Last updated:** 2026-04-10  **Total records:** 1261
...
| Metric | Value |
|--------|-------|
| Total incidents | 1261 |
| With CVE/GHSA references | 57 (5%) |
| Unique CVEs/GHSAs | 66 |
| With malware identified | 213 (17%) |
| Supply chain claimed | 783 (62%) |
| Unique vendor products | 850 |
...
| Unauthorized access / data exposure | 4 |
...
| Third-party / vendor compromise | 2 |
...
| A coding error in PayPal's application enabled unauthorized data access and facilitated fraud against a subset of PayPal users; the error was in the app's data handling logic rather than a direct attack by external threat actors | 1 |
