...
**Last updated:** 2026-04-10  **Total records:** 405
...
|--------|-------|
| Total incidents | 405 |
| With CVE/GHSA references | 41 (10%) |
| Unique CVEs/GHSAs | 53 |
| With malware identified | 126 (31%) |
| Supply chain claimed | 78 (19%) |
| Unique vendor products | 252 |
| Median disclosure lag (days) | 32 |
